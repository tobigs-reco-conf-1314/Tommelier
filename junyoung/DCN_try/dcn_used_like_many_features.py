# -*- coding: utf-8 -*-
"""DCN_used_like_many_features.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1xvOnP9bErN-lS4iOSxsR__-a2QmnaFNl
...
INT_FEATURES = ["type_id", "body", "acidity", "like", 'user_like_count', 'rating_count', 'label_count', 'alcohol', 'winery_id', 'region_id','winery_ratings_count', 'winery_labels_count', 'winery_wines_count', 'user_follower_count', 
                'user_following_count', 'user_rating_count', 'user_rating_sum', 'reviews_count']
...
int_features = ["type_id", "body", "acidity", "like", "user_like_count", 'rating_count', 'alcohol', 'winery_id', 'region_id', 'winery_ratings_count', 'winery_labels_count', 'winery_wines_count', 'user_follower_count', 'user_following_count',
...
feature_names = ["userID", "country_code", 'grapes_id_unique', "type_id", "body", "acidity", "like", "user_like_count", 'rating_count', 'alcohol', 'winery_id', 'region_id', 'winery_ratings_count', 'winery_labels_count', 'winery_wines_count', 'user_follower_count', 'user_following_count',
                'user_rating_count', 'user_rating_sum', 'reviews_count']
...
class DCN(tfrs.Model):
  ...
  def __init__(self, use_cross_layer, deep_layer_sizes, projection_dim=None):
    ...
    str_features = ["userID", "country_code", 'grapes_id_unique']
    int_features = ["type_id", "body", "acidity", "user_like_count", 'rating_count', 'alcohol', 'winery_id', 'region_id', 'winery_ratings_count', 'winery_labels_count', 'winery_wines_count', 'user_follower_count', 'user_following_count',
                'user_rating_count', 'user_rating_sum', 'reviews_count']
